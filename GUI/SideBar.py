...
from GUI.Paths import BOARD_IMAGE_PATH, THEME_PATH, resource_path
import brains
...
class SideBar(ctk.CTkFrame):
    ...
    def __init__(self, ParentObject):
        ...
        photo = Image.open(resource_path("Misc", "SaveIcon.png"))
        ...
        photo = Image.open(resource_path("Misc", "AppearanceModeIcon.png"))
        ...
        self.PreferencesButton = ctk.CTkButton(
            ...
            image=ctk.CTkImage(
                light_image=Image.open(
                    resource_path("Misc", "PreferencesIcon.png")
                ),
    ...
    def CopyFENToClipboard(self):
        ...
        pygame.image.save(self.ParentObject.Display, BOARD_IMAGE_PATH)
        pyperclip.copy(fen)
        messagebox.showinfo(
