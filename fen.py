...
FEN_STRING_PATH = Path(__file__).resolve().with_name("fenString.txt")

with open(FEN_STRING_PATH, "r") as file:
...
def convert_bitboards_to_fen(bitboard, board_data):
    ...
    fen += " "
    bit_positions_for_castling = {1: "K", 2: "Q", 3: "k", 4: "q"}
